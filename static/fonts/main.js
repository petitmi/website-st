...
function formSubmitCallback(formContextMsg) {
  ...
  confirmationEle.innerHTML = '<div class="container flex flex-justify-space-between flex-align-center"><p class="mb-0">' + formContextMsg + '</p> <button class="button-primary compact-round flex-align-center close-banner" aria-label="Close">Ã—</button></div>';
...
subMenuContainersLastItem.forEach((li) => {
  li.innerHTML = li.innerHTML.replace(/â”œâ”€â”€/g, "â””â”€â”€");
});
