...
The original button color is #305CDE, and we want to investigate how changing the button color to #E49B0F affects user click-through rates.

- Null Hypothesis (H0): Changing the button color from #305CDE to #E49B0F has no effect on user click-through rates.  
- Alternative Hypothesis (H1): Changing the button color to #E49B0F, as compared to #305CDE, positively impacts user click-through rates.
...
When the button is #305CDE, the average daily click-through rate for users is 2%. Now, the desired increase in click-through rate with the color change to #E49B0F is 0.4pp (MDE = 0.4%/2% = 20%), aiming for 2.4%.
